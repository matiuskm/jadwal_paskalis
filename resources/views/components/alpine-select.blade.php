@props(['field', 'options', 'selected' => '', 'searchPlaceholder'])
...
<div x-data="multiselect({ items: $options })" x-init="onInit" @focusout="handleBlur" {{ $attributes->merge(['class' => 'mt-4 flex-1 relative']) }}>
