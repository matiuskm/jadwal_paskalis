...
<div x-data="dropdown()" x-init="init('{{$name}}')" class="w-full flex flex-col items-center mx-auto">
  ...
  <div class="inline-block relative w-full">
    <div class="flex flex-col items-center relative">
      <div x-on:click="open" class="w-full">
        <div class="my-2 p-1 flex border border-gray-200 bg-white dark:bg-gray-800 rounded">
  ...
  " />
      ...
      <div class="w-full px-4">
        <div x-show.transition.origin.top="isOpen()" class="absolute shadow top-100 bg-white dark:bg-gray-800 dark:text-gray z-40 w-full left-0 rounded max-h-select" x-on:click.away="close">
